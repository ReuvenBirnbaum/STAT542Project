...
One of the ideal methods is to **drop** any row who has one or more missing values. Also because records which have at least one missing value, have other columns with weird values that cannot be employed.
